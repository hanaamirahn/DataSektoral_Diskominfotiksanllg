...
if menu == "Dinas Lingkungan Hidup (DLH)":
    ...
    dlh_df = pd.read_csv("dataset/DLH.csv")
...
# DISNAKER
    ...
    df = pd.read_csv("dataset/disnaker.csv")
    st.dataframe(df)
...
# DINKES
    ...
    df = pd.read_csv("dataset/dinkes.csv")
    st.dataframe(df)
...
# DISKOP
    ...
    df = pd.read_csv("dataset/diskop.csv")
    st.dataframe(df)
...
# DINPER
    ...
    df = pd.read_csv("dataset/dinper.csv")
    st.dataframe(df)
